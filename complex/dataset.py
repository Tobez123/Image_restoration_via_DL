...
IMG_EXTENSIONS = ['.jpg', '.jpeg', '.png', '.bmp', '.tif', '.JPEG']


def has_file_allowed_extension(filename, extensions):
    """Checks of a file is an allowed extension
...
class ImageFolder(data.Dataset):
    ...
    def __init__(self, root, loader = pil_loader, extensions=IMG_EXTENSIONS, transform=None, target_transform=None, return_path=False):
...
class PairedImageFolder(data.Dataset):
    ...
    def __init__(self, root1, root2, loader = pil_loader, extensions=IMG_EXTENSIONS, transform=None, target_transform=None):
